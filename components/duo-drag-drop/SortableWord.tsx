...
import Animated, { useAnimatedStyle, useSharedValue, useDerivedValue, withTiming, runOnJS } from "react-native-reanimated";
...
const SortableWord = ({
  ...
  const translateX = useDerivedValue(() => {
    ...
    return withTiming(isInBank.value ? offset.originalX.value : offset.x.value, { duration: 250 }, () => (isAnimating.value = false));
  });
  ...
  const translateY = useDerivedValue(() => {
    ...
    return withTiming(isInBank.value ? offset.originalY.value + wordBankOffsetY : offset.y.value, { duration: 250 }, () => (isAnimating.value = false));
  });
